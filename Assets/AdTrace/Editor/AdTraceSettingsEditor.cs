...
{
    [CustomEditor(typeof(AdTraceSettings))]
    public class AdTraceSettingsEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(androidPermissionInternet,
                new GUIContent("android.permission.INTERNET",
                    "Android permission needed to send data to AdTrace backend"),
                true);
            ...
            EditorGUILayout.HelpBox(
                "Please note that AdTrace SDK doesn't remove existing URI Schemes, " +
